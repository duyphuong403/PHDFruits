...
$tv="select * from list_order where status = 1 order by id desc limit $vtbd,$so_dong_tren_mot_trang";
$tv_1=mysqli_query($connect,$tv);
?>
<div class="col-md-9">
    <center>
       <h2 style="text-transform: uppercase;display: inline-block;color: blue">Đơn Hàng Đã Giao</h2><br>
